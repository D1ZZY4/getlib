...
import { probeLlmsTxt, resolveFromNpm, resolveFromPypi } from "../../src/services/resolve.js";
import { fetchWithTimeout, fetchNpmPackage, fetchPypiPackage } from "../../src/services/fetcher.js";
...
beforeEach(async () => {
  ...
  const { llmsProbeCache, resolveCache } = await import("../../src/services/cache.js");
