...
vi.mock("../../src/services/snippets/build-index.js", () => ({
...
import { fetchWithTimeout, githubAuthHeaders } from "../../src/services/fetcher.js";
import { docCache, diskDocCache } from "../../src/services/cache.js";
