...
import { registerMigrationTool, filterReleasesByVersion } from "../../src/tools/migration.js";
...
vi.mock("../../src/services/search/url-rank.js", () => ({
...
import { fetchGitHubContent, fetchGitHubReleases, fetchAsMarkdownRace } from "../../src/services/fetcher.js";
...
describe("web-search escalation (releases alone are not a migration guide)", () => {
  it("finds the official upgrade guide when only GitHub Releases matched", async () => {
    const { lookupById } = await import("../../src/sources/registry.js");
    const { fetchGitHubContent, fetchGitHubReleases, fetchAsMarkdownRace } = await import("../../src/services/fetcher.js");
    const { webSearch } = await import("../../src/services/search/engines.js");
