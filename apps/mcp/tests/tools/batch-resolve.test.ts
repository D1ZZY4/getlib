...
import { registerBatchResolveTool } from "../../src/tools/batch-resolve.js";
import { fuzzySearch, lookupByAlias } from "../../src/sources/registry.js";
...
vi.mock("../../src/utils/guard.js", async (importOriginal) => ({
  ...(await importOriginal<typeof import("../../src/utils/guard.js")>()),
