...
import { registerSearchTool, findTopicUrls } from "../../src/tools/search.js";
...
import { fuzzySearch, lookupById } from "../../src/sources/registry.js";
import { fetchDocs, fetchWithTimeout, fetchViaJina, fetchAsMarkdownRace, fetchDevDocs } from "../../src/services/fetcher.js";
...
describe("isAuthoritativeUrl", () => {
  it("accepts curated official/standards domains incl. subdomains", async () => {
    const { isAuthoritativeUrl } = await import("../../src/tools/search.js");
